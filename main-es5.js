...
var ShowproductoComponent = /** @class */ (function () {
    function ShowproductoComponent(service) {
    ...
    Object.defineProperty(ShowproductoComponent.prototype, "appBacon", {
    ...
    Object.defineProperty(ShowproductoComponent.prototype, "appBacon2", {
        set: function (paginator) {
    ...
    ShowproductoComponent.prototype.ngAfterViewInit = function () {
        // this.listData.paginator =  this.paginator;
    };
    ShowproductoComponent.prototype.refreshProductoList = function () {
        var _this = this;
        this.service.getProductoList(src_app_models_producto_model__WEBPACK_IMPORTED_MODULE_2__["Producto"]).subscribe(function (resultados) {
            var array4;
            array4 = resultados[0];
            var array4_2;
            ...
            array4.results.forEach(function (element) {
                ...
                array5.push(array3);
                _this.listData.filteredData.push(array3);
                return;
            });
            array5.shift();
            _this.listData.filteredData.shift();
            array4_2.results.forEach(function (element) {
                ...
                _this.listData.filteredData.push(array3_2);
                return;
            });
            array5_2.shift();
            // this.listData.paginator = this.paginator;
            ...
            _this.producto = array5.concat(array5_2);
            _this.listData.paginator = _this.paginator;
            //console.log(this.listData.paginator)
        });
    };
    ShowproductoComponent.ctorParameters = function () { return [
...
var ProductoService = /** @class */ (function () {
    ...
    ProductoService.prototype.getProductoList = function (Producto) {
        var response1 = this.http.get(this.APIUrl);
        var response2 = this.http.get(this.APIUrl2);
